...
def test_func_existance():
    ...
    assert isinstance(DataPlotter.plot_data_air, types.FunctionType)
    assert isinstance(DataPlotter.darken_color, types.FunctionType)
    assert isinstance(DataPlotter.plot_data_air_color, types.FunctionType)
    assert isinstance(DataPlotter.plot_water_data, types.FunctionType)
    assert isinstance(DataPlotter.plot_data_water_color, types.FunctionType)
